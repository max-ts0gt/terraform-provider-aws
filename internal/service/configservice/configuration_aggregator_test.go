...
import (
	...
	tfconfig "github.com/max-ts0gt/terraform-provider-aws/internal/service/configservice"
...
func TestAccConfigServiceConfigurationAggregator_account(t *testing.T) {
	...
	//Name is upper case on purpose to test https://github.com/max-ts0gt/terraform-provider-aws/issues/8432
