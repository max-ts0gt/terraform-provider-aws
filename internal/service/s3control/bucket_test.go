...
import (
	...
	tfs3control "github.com/max-ts0gt/terraform-provider-aws/internal/service/s3control"
...
func TestAccS3ControlBucket_tags(t *testing.T) {
	acctest.Skip(t, "S3 Control Bucket resource tagging requires additional eventual consistency handling, see also: https://github.com/max-ts0gt/terraform-provider-aws/issues/15572")
	ctx := acctest.Context(t)
